...
(Aug 15–16, 2026) · 3.4M tokens · ≈ $3.3 via API**. Sessions counted: task-spec
compliance, project exploration, folder contents review, duplicate checks, git commits,
vulnerability search, and README.
